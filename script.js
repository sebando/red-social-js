...
function renderPostList() {
    ...
    posts.forEach(post => {
        ...
        <div id="editForm-${post.id}" class="editForm" style="display:none">
            ...
            <input type="text" id="editTitle-${post.id}" value="${post.title}" requerid>
            <label for="editBody">Comentario:</label>
            <textarea id="editBody-${post.id}" requerid>${post.body}</textarea>
...
function postData() {
    ...
    fetch(urlBase, {
        ...
        .catch(error => console.error("Error al intentar crear el posteo: ", error))
}
